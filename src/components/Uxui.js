        ...
        <section class="benefits">
                ...
                <div class="container-motivos-ux">
                    ...
                    <div>                    
                        ...
                        <ul>
                            <li>
                                <h3>Optimización del flujo de trabajo interno:</h3><p> Interfaces administrativas claras y procesos automatizados de gestión de inventarios, pedidos y envíos permiten que el personal trabaje de manera más eficiente, evitando duplicación de tareas y posibles errores humanos.</p>
                            </li>
                            <li>
            ...
            <section class="dark-back">                
                    <div class="container-servicios-ux">
                            ...
                            <router-link to="/contacta" class="big-btn2" target= "_blank"rel="noopener noreferrer">CONTACTAR</router-link>
                    </div>               
            </section>

            <section class="full-width-div">            
                    ...
                    <div class="black-background">
                            ...
                            <div class="column-left-16">
                                ...
                                <div>
                                    ...
                                    <p>La interfaz adopta un enfoque minimalista con un diseño oscuro que reduce la fatiga visual especialmente en sesiones prolongadas, mientras que los colores de acento en naranja resaltan la información más relevante. Este contraste permite una rápida identificación de los elementos interactivos y destaca gráficos o botones clave sin saturar la vista del usuario.</p>
                                </div>
                    ...
                    <div class="black-background">
                            ...
                            <div class="column-left-16">
                                <div>
                                    ...
                                    <p>En el desarrollo de la experiencia digital, mi enfoque fue crear una plataforma que transmita la exclusividad. Este proyecto de diseño UX/UI busca combinar elementos visuales elegantes con una navegación intuitiva. </p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <ul>                                
                                        ...
                                        <li> Especial Regalos: Esta sección está pensada para captar el interés de usuarios que buscan ideas de regalo, destacando joyas de diferentes estilos. </li>
                                        <li> Las fotografías de producto con modelos en uso, ayuda a los usuarios a visualizar el look final de las joyas, transmitiendo autenticidad y aspiración </li>
                                        <li> Se dedica un espacio destacado a "Gold Collection", una de las líneas premium de la marca. La sección cuenta con una imagen llamativa que resalta el color dorado y la exclusividad de esta colección, acompañada por un botón de llamada a la acción que invita a explorar. </li>
                                ...
                                <div class="container-img-focus">
                                    <img class="img-focus" src="/images/omega.svg" loading="lazy" alt="imagen inicio sesión proyecto tienda" style="border:2px solid #373737"> 
                                </div>
                                <div>    
