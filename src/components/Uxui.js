  ...
  template: `
        ...
        <section class="uxui">
            ...
            <div class="container-row">
                   ...
                   <img class="img-pc"src="../img/pexels-photo-by-fauxels.png" alt="foto-pc-slogan">
            </div>
            ...
            <div class="dark-back">
                <div class="container-servicios-ux">
                    <h2> Servicios de Diseño UX/UI </h2>
                        ...
                        <a class="btn1" href="contacta.html" target="_blank" rel="noopener noreferrer">CONTACTAR </a>
                </div>
            </div>
                    ...
                    <div class="black-background">
                        <div class= "container-row" >
                            <div class="p-column">
                                ...
                                <p><strong>En el desarrollo de la experiencia digital  Omega, mi enfoque fue crear una plataforma que transmita la exclusividad y sofisticación. Este proyecto de diseño UX/UI busca combinar elementos visuales elegantes con una navegación intuitiva. </strong></p>
                                <div>
                        ...
                        <div class= "container-row" >
                            ...
                            <img class="img-focus" src="../img/omega.svg"  alt="imagen inicio sesión proyecto tienda" style= "border:2px solid #373737"> 
                            </div>
                            <div class="p-column">
                                <div>
                    ...
                    <div class="black-background">
                        <div class= "container-row" >
                            <div class="p-column">
                                ...
                                <p><strong>El proyecto App bancaria se centra en optimizar la accesibilidad a información financiera clave en un entorno de dark mode. El objetivo principal fue reducir la carga cognitiva de los usuarios, permitiendo que accedan a sus productos financieros, saldos y gastos de forma rápida y clara.</strong></p>
                                <div>
                            ...
                            <div class="container-img-focus">
                                <img class="img-focus" src="../img/bank.svg"  alt="imagen inicio sesión proyecto tienda"> 
                            </div>                                
                        </div>
                    ...
                    <div class="black-background">
                        <div class="container-column-pdd">
                            ...
                            <div class= "container-row" >
                                ...
                                <div class="container-img-focus">
                                    <img class="img-focus" src="../img/menu-tien.png"  alt="imagen inicio sesión proyecto tienda">
                                    
                                </div>
                                <div class="container-img-focus">
                                    <img class="img-focus" src="../img/tianimal-foto.png"  alt="imagen inicio sesión proyecto tienda">
                            ...
                            <div class="container-column-pdd">
                                <h4>Rediseño </h4>
                                <p>Para abordar estos conflictos de manera integral, se propone un rediseño enfocado en mejorar la usabilidad y la claridad visual, sin comprometer la estética gráfica.</p> 
                                <ul>                                                                            
                            ...
                            <div class="container-row">
                                    <div class="p-column">
                                         ...
                                         <p>Este rediseño manteniene la estética visual de la marca mejorando su funcionalidad. Los usuarios pueden encontrar la información relevante en puntos estratégicos de la interfaz.
</p>    
                                        
                                    </div>
                                    <div class="container-img-focus">
                                        <img class="img-focus" src="../img/tien-foto.png"  alt="imagen inicio sesión proyecto tienda"> 
                                    </div>                                       
